...
public class DrillBlockVisual extends AbstractPulleyVisual<DrillBlockEntity> {
    public DrillBlockVisual(VisualizationContext dispatcher, DrillBlockEntity blockEntity, float partialTick) {
